...
Vulnerability lookup has no fixed package-count cutoff. Supported packages are sent to OSV in batches of 100 with at most four batches in flight. OSV pagination is followed per package, and full advisory records are fetched with bounded concurrency.
...
The report exposes candidate, unpinned, supported, unsupported, completed, and incomplete vulnerability lookup counts. This distinguishes "no vulnerability was found" from "this dependency could not be checked."
